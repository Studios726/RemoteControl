...
public class BucketWheelStackerReclaimerState : BucketWheelStateBase
{
   ...
   public override void UpdateData(SystemVariables data)
   {
        ...
        SetToggleState(systemChain, data.SR1_Interlock_Swich, false, data.D1PLC1CommunicationState);
        SetToggleState(localSystemChain, data.SystemInterlockSwitch, false, data.D1PLC1CommunicationState);
